      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header">MANAJEMEN PENJUALAN</li>
            ...
            <li class="<?php if($_GET['menu']=='pemesanan-produk') echo 'active'; ?>">
             ...
             <li class="<?php if($_GET['menu']=='jadwal-pengiriman') echo 'active'; ?>">
              <a href="?menu=jadwal-pengiriman">
                <i class="fa fa-calendar text-blue"></i> <span>Jadwal Pengiriman</span>
              </a>
            </li>
