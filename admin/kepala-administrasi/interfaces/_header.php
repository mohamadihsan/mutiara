      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($_GET['menu']=='pengguna') echo 'active'; ?>">
              <a href="?menu=pengguna">
                <i class="fa fa-user text-blue"></i> <span>Data Pegawai</span>
                <span class="pull-right-container">
                </span>
              </a>
            </li>
            <!-- <li class="<?php if($_GET['menu']=='pelanggan') echo 'active'; ?>">
              <a href="?menu=pelanggan">
                <i class="fa fa-child text-primary"></i> <span>Data Pelanggan</span>
                <span class="pull-right-container">
                </span>
              </a>
            </li> -->
            <!-- <li class="<?php if($_GET['menu']=='supplier') echo 'active'; ?>">
              <a href="?menu=supplier">
                <i class="fa fa-user text-green"></i> <span>Data Supplier</span>
                <span class="pull-right-container">
                </span>
              </a>
            </li> -->
            <li class="<?php if($_GET['menu']=='kendaraan') echo 'active'; ?>">
              <a href="?menu=kendaraan">
                <i class="fa fa-truck text-yellow"></i> <span>Data Kendaraan</span>
                <span class="pull-right-container">
                </span>
              </a>
            </li>
