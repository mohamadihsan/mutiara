      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($_GET['menu']=='produk') echo 'active'; ?>">
              <a href="?menu=produk">
                <i class="fa fa-cube text-danger"></i> <span>Data Produk</span>
              </a>
            </li>

            <li class="<?php if($_GET['menu']=='peramalan') echo 'active'; ?>">
              <a href="?menu=peramalan">
                <i class="fa fa-reorder text-yellow"></i> <span>Peramalan Produksi</span>
              </a>
            </li>

            <li class="header">LAPORAN</li>

            <li class="<?php if($_GET['menu']=='laporan-produk' OR $_GET['menu']=='laporan-peramalan') echo 'active'; ?> treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php if($_GET['menu']=='laporan-peramalan') echo 'active'; ?>">
                  <a href="?menu=laporan-peramalan">
                    <i class="fa fa-book text-white"></i> <span>Peramalan Produksi</span>
                  </a>
                </li>
              </ul>  
            </li>
