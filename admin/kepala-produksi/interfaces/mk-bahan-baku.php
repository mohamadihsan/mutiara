...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Masuk & Keluar Bahan Baku</li>
      </ol>
    </section>
	<!-- Main content -->
        	...
        	<div class="col-xs-12">
		        ...
		        <div class="nav-tabs-custom">
		            <ul class="nav nav-tabs pull-right">
		             	...
		             	<li class="pull-left header"><i class="fa fa-building"></i> Barang Masuk & Keluar <small>(Bahan Baku)</small></li>
		            </ul>
		              	...
		              	<div class="tab-pane active" id="tab_2-2">
		                	<table id="example1" class="table table-striped table-bordered dt-responsive nowrap">
				                ...
				                <tbody>
					                ...
					                <?php
					                $sql = "SELECT arus_bahan_baku.id, arus_bahan_baku.id_bahan_baku, kode, nama, satuan, waktu, status, jumlah,  DATE_FORMAT(waktu, '%H:%i:%s') AS jam FROM bahan_baku, arus_bahan_baku WHERE bahan_baku.id=arus_bahan_baku.id_bahan_baku";
									    ...
									    while($row = mysqli_fetch_assoc($result)) {
									        ...
									        <tr>
							                  	...
							                  	<td width="10%" class="text-right">
							                  		<button class="btn btn-sm btn-warning" title="Ubah Data" data-toggle="modal" data-target="#modalUbah" onclick="return ubah('<?= $id ?>','<?= $id_bahan_baku ?>','<?= $status ?>','<?= $jumlah ?>')"><i class="fa fa-edit"></i></button>
      	...
      	<div class="modal-content">
	        ...
	        <form action="" method="post" accept-charset="utf-8" class="form-horizontal">
	        		...
	        		<div class="form-group">
	                  	...
	                  	<div class="col-sm-9">
	                  		<div class="input-group">
				                ...
				                <select class="form-control select2" style="width: 100%;" name="id_bahan_baku" id="id_bahan_baku" required="">	
				                	<?php  
				                	$sql = "SELECT id, kode, nama, satuan FROM bahan_baku";
				                	$result = mysqli_query($conn, $sql);
				                	while ($row=mysqli_fetch_assoc($result)) {
				                		?>
				                		<option value="<?= $row['id'] ?>"><?= strtoupper($row['kode']).' - '.ucwords($row['nama']) ?></option>
				                		<?php
				                	}
				                	?>
				                </select>
		        ...
		        <div class="modal-footer">
		          	...
		          	<button type="submit" class="btn btn-success" name="simpan_mk_bahan_baku">Simpan</button>
		        </div>
	        </form>
    	</div>
	</div>
    ...
    <div class="modal-dialog modal-md">
      	<div class="modal-content">
	        ...
	        <form action="" method="post" accept-charset="utf-8" class="form-horizontal">
	        		...
	        		<input type="hidden" name="id" id="id" class="form-control" placeholder="" required="">
		          	...
		          	<div class="form-group">
	                  	...
	                  	<div class="col-sm-9">
	                  		<div class="input-group">
				                <span class="input-group-addon"><i class="fa fa-cubes"></i></span>
				                <select class="form-control select" style="width: 100%;" name="u_id_bahan_baku" id="u_id_bahan_baku" required="">	
				                	<?php  
				                	$sql = "SELECT id, kode, nama, satuan FROM bahan_baku";
				                	$result = mysqli_query($conn, $sql);
				                	while ($row=mysqli_fetch_assoc($result)) {
		        ...
		        <div class="modal-footer">
		          	<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
		          	<button type="submit" class="btn btn-success" name="ubah_mk_bahan_baku">Simpan Perubahan</button>
		        </div>
	        </form>
    	</div>
	</div>
    ...
    <div class="modal-dialog modal-md">
      	<div class="modal-content">
	       ...
	       <form action="" method="post" accept-charset="utf-8" class="form-horizontal">
		        ...
		        <div class="modal-footer">
		          	<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
		          	<button type="submit" class="btn btn-danger" name="hapus_mk_bahan_baku">Hapus</button>
		        </div>
	        </form>
    	</div>
	</div>
...
<script type="text/javascript">
	...
	function ubah(id, id_bahan_baku, status, jumlah){
		$('.modal-body input[name=id]').val(id);
		$('.modal-body select[name=u_id_bahan_baku]').val(id_bahan_baku);
