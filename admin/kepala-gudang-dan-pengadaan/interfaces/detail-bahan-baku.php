...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="?menu=bahan-baku"><i class="fa fa-cubes"></i> Bahan Baku</a></li>
        	...
        	<div class="col-xs-12">
		        ...
		        <div class="nav-tabs-custom">
		            <ul class="nav nav-tabs pull-right">
		              	<li><a href="?menu=bahan-baku" class="text-bold"><i class="fa fa-arrow-left text-black"></i> Kembali</a></li>
		              	...
		              	<div class="tab-pane active" id="tab_2-2">
		                	<table id="example1" class="table table-striped table-bordered dt-responsive nowrap">
				                ...
				                <tbody>
					                ...
					                <?php
					                $id = $_GET['id'];
					                $sql = "SELECT kode, nama, satuan, SUM(stok) as stok, tanggal_kadaluarsa FROM bahan_baku, detail_bahan_baku WHERE bahan_baku.id=detail_bahan_baku.id_bahan_baku AND id='$id' GROUP BY tanggal_kadaluarsa";
				                ...
				                <tfoot>
				                	<tr>
				                		<th colspan="2" rowspan="" headers="" scope="" class="text-center">TOTAL STOK</th>
