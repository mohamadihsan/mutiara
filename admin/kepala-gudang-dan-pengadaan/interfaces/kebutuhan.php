...
<script type="text/javascript">
    ...
    function peramalan(){
		...
		$('.modal-body a[name=detail]').val('<?= "?menu=detail-kebutuhan&f=". $peramalan_selanjutnya ."&id=". $id ."&periode=". $bulan_terakhir."-".$tahun_terakhir ?>');
	}
    <?php
    $periode_terakhir = $bulan_terakhir."-".$tahun_terakhir;
    ?>
    $(document).ready(function(){
        $('#link_detail').html("<a class='btn btn-info' href='?menu=detail-kebutuhan&f=<?= $peramalan_selanjutnya ?>&id=<?= $id ?>&periode=<?= $periode_terakhir ?>'>Detail Kebutuhan</a><button type='button' class='btn btn-default' data-dismiss='modal'>Kembali</button>");
    });
