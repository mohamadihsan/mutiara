      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($_GET['menu']=='daftar-pesanan') echo 'active'; ?>">
              <a href="?menu=daftar-pesanan">
                <i class="fa fa-file-text-o text-yellow"></i> <span>Daftar Pesanan</span>
              </a>
            </li>

            <li class="<?php if($_GET['menu']=='barang-yang-dijual') echo 'active'; ?>">
              <a href="?menu=barang-yang-dijual">
                <i class="fa fa-cubes text-red"></i> <span>Barang</span>
              </a>
            </li>
