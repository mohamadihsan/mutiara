		              	...
		              	<div class="tab-pane active" id="tab_2-2">
		                	<table id="example1" class="table table-striped table-bordered dt-responsive nowrap">
				                ...
				                <tbody>
					                ...
					                <?php
					                $sql = "
					                SELECT arus_bahan_baku.id, arus_bahan_baku.id_bahan_baku, kode, nama, satuan, waktu, status, jumlah,  DATE_FORMAT(waktu, '%H:%i:%s') AS jam 
					                FROM bahan_baku, arus_bahan_baku 
					                WHERE bahan_baku.id=arus_bahan_baku.id_bahan_baku
					                ORDER BY waktu DESC";
