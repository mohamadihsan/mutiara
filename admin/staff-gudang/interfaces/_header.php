      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($_GET['menu']=='mk-bahan-baku' OR $_GET['menu']=='mk-produk') echo 'active'; ?> treeview">
              <a href="#">
                <i class="fa fa-exchange text-red"></i> <span>Barang Masuk & Keluar</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li class="<?php if($_GET['menu']=='mk-bahan-baku') echo 'active'; ?>"><a href="?menu=mk-bahan-baku"><i class="fa fa-file-text"></i> Bahan Baku</a></li>
                <li class="<?php if($_GET['menu']=='mk-produk') echo 'active'; ?>"><a href="?menu=mk-produk"><i class="fa fa-file-text"></i> Produk</a></li>
              </ul>
            </li>
          </ul>
        </section>
