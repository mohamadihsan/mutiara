		              	...
		              	<div class="tab-pane active" id="tab_2-2">
		                	<table id="example1" class="table table-striped table-bordered dt-responsive nowrap">
				                ...
				                <tbody>
					                ...
					                <?php
					                $sql = "
					                SELECT arus_produk.id, arus_produk.id_produk, kode, nama, jenis_kemasan, satuan, waktu, status, jumlah,  DATE_FORMAT(waktu, '%H:%i:%s') AS jam 
					                FROM produk, arus_produk 
					                WHERE produk.id=arus_produk.id_produk
					                ORDER BY waktu DESC";
